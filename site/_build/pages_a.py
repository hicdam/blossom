      ...
      <div class="wrap">
        <div class="grid-3">
          ...
          <div class="reveal">
            ...
            <p class="smallprint">As a guide: Garden Review £295, design fees typically 10 to 15 percent of the build budget, project management from £950 a month, retained management from £250 a month. Exact fees depend on the size, complexity and level of responsibility involved and are confirmed in writing before the service begins.</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="section">
      <div class="wrap grid-2" style="align-items: start;">
        ...
        <div class="reveal">
          ...
          <p>The Garden Management Review establishes the starting point. As a guide, the ongoing retainer starts from £250 a month and reflects the garden's scale, complexity, supplier network, inspection frequency and the level of responsibility you want Blossom to take.</p>
